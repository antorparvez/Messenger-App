...
public class SinchService extends Service {
    private static final String APP_KEY = "a60c3de9-8964-4c66-8fe8-498f0b67993d";
    private static final String APP_SECRET = "SF3Bc3yrdUypc6jUWVROsA==";
    private static final String ENVIRONMENT = "clientapi.sinch.com"; //clientapi.sinch.com
    ...
    private class SinchCallClientListener implements CallClientListener {
        ...
        public void onIncomingCall(CallClient callClient, Call call) {
            try {
                ...
                //Implement Local Storage for saving chatlist
